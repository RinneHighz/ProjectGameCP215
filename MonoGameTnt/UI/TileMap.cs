...
namespace ThanaNita.MonoGameTnt
{
    public class TileMap : Actor
    {
        ...
        public int[,] TileArray => tileArray;
        public Actor[,] TileActors { get; private set; }
        ...
        {
            TileActors = new Actor[tileArray.GetLength(0), tileArray.GetLength(1)];
            AddBackground();
        ...
        {
            return TileCenter(new Vector2i(x, y));
        }
